...
import './dnd5e/apps/ability-use-dialog';
import './dnd5e/apps/actor-flags';
import './dnd5e/apps/long-rest';
import './dnd5e/apps/movement-config';
import './dnd5e/apps/senses-config';
import './dnd5e/apps/short-rest';
